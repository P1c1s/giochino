...
func _physics_process(_delta):
	#if the player isn't near the monster, the enemy moves with his default dynamic
...
#if the monster doesn't chase the player, he moves back and forth between two points A and B
...
#if the monster is chasing the player, the player's position is set to be the endPosition
#if the distance betweem the player and the monster is under a limit, he starts to attack
func chase():
...
#at the end of the cooldown the monster attaks again
