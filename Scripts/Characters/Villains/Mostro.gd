...
func _ready():
	...
	endPosition = startPosition - Vector2(-90, 0)
...
#if the mostro doesn't chase the player, he moves back and forth between two points A and B
...
#at the end of the cooldown the mostro attaks again
